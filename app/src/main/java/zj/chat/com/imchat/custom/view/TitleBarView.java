...
import zj.chat.com.imchat.util.SystemMethod;
...
public class TitleBarView extends RelativeLayout {
     ...
     * @param i
     */
    public void setTitleOpenVisibilty(int i) {
        common_constact.setVisibility(i);
    }
    ...
    public void setTitleRighe(String msg, OnClickListener mOnClickListener) {
