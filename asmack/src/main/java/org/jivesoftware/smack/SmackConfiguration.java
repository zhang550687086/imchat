 ...
 * $RCSfile$
 * $Revision: 12957 $
 * $Date: 2012-01-27 15:30:09 -0600 (Fri, 27 Jan 2012) $
 *
 ...
 * </ul>
 *
 * Configuration settings are stored in data/smack-config.xml (typically inside the
 * smack.jar file).
 * 
    ...
    static {
        try {
            ...
            for (ClassLoader classLoader : classLoaders) {
                Enumeration configEnum = classLoader.getResources("data/smack-config.xml");
